...
{{--
                <div class="text-sub-product">
                    ...
                    <div class="product-price">
                        <h3>{{ transWord('جنية') }} {{ $product->total_price }} </h3>
                        @if ($product->discount)
                            <h4> {{ $product->price }} {{ transWord('جنية') }} </h4>
            ...
            <div class="btns-product">
                ...
                <div class="shareLinksProduct-{{ $product->id }} main-share-links" style="display: none;">
                ...
                <a href="{{ route('site.cart.store') }}"
                    class="{{ auth()->user() ? 'btn-cart' : 'auth_login btn-cart' }}" data-id="{{ $product->id }}">
                ...
                <a href="javascript:void(0);" class="btn_share_product" data-id="{{ $product->id }}">
