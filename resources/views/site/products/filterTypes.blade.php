            ...
            <ul class="categories-a-filter ">
                ...
                <li>
                    <div class="input-radio">
                        <input type="radio" id="categories-{{ $category->id }}" name="categories" class="filter category_filter" data-category-id="{{ $category->id }}">
            ...
            <ul class="check-filter">
                @forelse ($brands as $brand)
                    <li class="input-check">
                        ...
                        <label for="check-{{ $brand->id }}"> {{ $brand->name }} </label>
                    </li>
                @empty
                    <li>
        ...
        <div class="sub-filter-products">
            ...
            <div class="range_slider">
                ...
                <div class="number_range_slider">
                    ...
                    <input type="number" maxlength="10" value="100" class="from filter" name="min_num" id="min_num_filter" />
                    <input type="number" maxlength="10" value="1000" class="to filter" name="max_num" id="max_num_filter" />
                </div>
            </div>
        </div>
