...
@section('title', transWord('تعديل  كود خصم '))
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">{{ transWord('تعديل كود خصم ') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ transWord('تعديل كود خسم  ') }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical" action="{{ route('admin.coupons.update', $coupon->id ) }}"
                                        method="POST" id="UpdateCouponsForm" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            @method('PUT')
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class=" form-control select2" id="type" name="type">
                                                        ...
                                                        <option value="fixed"
                                                            @if (old('type' , $coupon->type) == 'fixed') selected @endif>
                                                            {{ transWord('ثابت') }}</option>
                                                        <option value="percentage"
                                                            @if (old('type', $coupon->type) == 'percentage') selected @endif>
