...
@section('title', transWord('تعديل المنتج'))
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">{{ transWord('تعديل المنتجات') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ transWord('تعديل المنتج') }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical" id="updateProductsForm"
                                        ...
                                        <div class="row" id="append">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="sub_title_ar" class="form-control"
                                                        name="sub_title_ar"
                                                        value="{{ old('sub_title_ar', $product->sub_title_ar) }}" />
                                                    @error('sub_title_ar')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="sub_title_en" class="form-control"
                                                        name="sub_title_en"
                                                        value="{{ old('sub_title_en', $product->sub_title_en) }}" />
                                                    @error('sub_title_en')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="label_ar" class="form-control"
                                                        name="label_ar"
                                                        value="{{ old('label_ar', $product->label_ar) }}" />
                                                    @error('label_ar')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="label_en" class="form-control"
                                                        name="label_en"
                                                        value="{{ old('label_en', $product->label_en) }}" />
                                                    @error('label_en')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                            ...
                                            <div class="col-4">
                                                ...
                                                <div class="form-group w-25 mr-3">
                                                    ...
                                                    <input type="color" id="label_color" class="form-control"
                                                        name="label_color"
                                                        value="{{ old('label_color', $product->label_color) }}" />
                                                    @error('label_color')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select_2" name="has_offer" id="has_offer"
                                                        required>
                                                        <option
                                                            {{ old('has_offer', $product->has_offer) == 1 ? 'selected' : '' }}
                                                            value="1">{{ transWord('نعم') }}
                                                        </option>
                                                        <option
                                                            {{ old('has_offer', $product->has_offer) == 0 ? 'selected' : '' }}
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control tinyEditor " id="desc_ar" name="desc_ar" rows="10" required>{{ old('desc_ar', $product->desc_ar) }}</textarea>
                                                    @error('desc_ar')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea style="visibility: hidden" class="form-control tinyEditor" id="desc_en" name="desc_en" rows="10"
                                                        required='required'>{{ old('desc_en', $product->desc_ar) }}</textarea>
                                                    @error('desc_en')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="dimensions_carton" class="form-control"
                                                        ...
                                                        value="{{ old('dimensions_carton', $product->details->dimensions_carton) }}" />
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="num_carton" class="form-control"
                                                        name="num_carton"
                                                        value="{{ old('num_carton', $product->details->num_carton) }}" />
                                                    @error('num_carton')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="size_carton" class="form-control"
                                                        name="size_carton"
                                                        value="{{ old('size_carton', $product->details->size_carton) }}" />
                                                    @error('size_carton')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="weight_carton" class="form-control"
                                                        name="weight_carton"
                                                        value="{{ old('weight_carton', $product->details->weight_carton) }}" />
                                                    @error('weight_carton')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="dimensions_product" class="form-control"
                                                        ...
                                                        value="{{ old('dimensions_product', $product->details->dimensions_product) }}" />
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <div id="colorInputsContainer">
                                                        ...
                                                        @php
                                                            $colors = old('color', $product->details->color); // Ensure there's at least one input
                                                        @endphp
