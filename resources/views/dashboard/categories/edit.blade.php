...
@section('title', transWord('تعديل القسم '))
...
@section('content')
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ transWord('تعديل القسم') }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical"
                                        action="{{ route('admin.categories.update',$category->id) }}" method="POST" id="updateCategoryForm"
    ...
    <script>
        window.Category = "{{ route('admin.check.CategoryName') }}";
    </script>
    @endpush
@endsection
