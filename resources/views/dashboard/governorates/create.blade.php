...
@section('title', transWord('مواد التصنيع'))
...
@section('content')
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('admin.brands.index') }}">{{ transWord('مواد التصنيع') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="#">{{ transWord('اضافه ماده تصنيع جديدة') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ transWord('اضافه ماده تصنيع جديدة') }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical"
                                        action="{{ route('admin.brands.store') }}" method="POST" id="brandsFormCreate"
    ...
    @push('js')
    <script>
        window.brandsUrl = "{{ route('admin.check.brand.name') }}";
    </script>
